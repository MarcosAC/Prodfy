                        ...
                        if (_dadosSincronismo.sinc_stat == 1)
                        {
                            ...
                            if (_dadosSincronismo.objetivo.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.objetivo.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        objetivoRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.ponto_controle.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.ponto_controle.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        pontoControleRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.estagio.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.estagio.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        estagioRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.monit_cod_arv.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.monit_cod_arv.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        monitCodArvRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.monit_parcela.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.monit_parcela.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        monitParcelaRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.colaborador.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.colaborador.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        colaboradorRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.lista_atv.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.lista_atv.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        listaAtvRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.qualidade.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.qualidade.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        qualidadeRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.exped_dest.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.exped_dest.Length; i++)
                                {
                                    ...
                                    if (deletarTodos == 0)
                                    {
                                        expedDestRepository.DeletarTodos();
                                        deletarTodos = 1;
                                    }
                            ...
                            if (_dadosSincronismo.inv.Length > 0)
                            {
                                ...
                                for (int i = 0; i < _dadosSincronismo.inv.Length; i++)
                                {
                                    inv = new Inv
                                    {
                                        idInv = int.Parse(_dadosSincronismo.inv[i].idInv.ToString()),
                                        inv_id = _dadosSincronismo.inv[i].inv_id,
                                        inv_item_id = _dadosSincronismo.inv[i].inv_item_id,
                                        qtde = _dadosSincronismo.inv[i].qtde,
                                        qtde_amostragem = _dadosSincronismo.inv[i].qtde_amostragem,                                        
