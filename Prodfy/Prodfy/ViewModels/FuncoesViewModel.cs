...
namespace Prodfy.ViewModels
{
    public class FuncoesViewModel : BaseViewModel
    {
        ...
        private async Task ExecuteIrPaginaIdentificacaoCommand() => await _navigationService.PushAsync(new IdentificacaoView());
        ...
        private async Task ExecuteIrPaginaAtividadeCommand() => await _navigationService.PushAsync(new AtividadeRealizadaView());
        ...
        private async Task ExecuteIrPaginaInventarioCommand() => await _navigationService.PushAsync(new CadastroInventarioView());
        ...
        private async Task ExecuteIrPaginaMovimentacaoCommand() => await _navigationService.PopAsync();
        ...
        private async Task ExecuteIrPaginaPerdasComand() => await _navigationService.PushAsync(new PerdasView());
        ...
        private async Task ExecuteIrPaginaHistoricoCommand() => await _navigationService.PushAsync(new HistoricoView());
        ...
        private async Task ExecuteIrPaginaLoteCommand() => await _navigationService.PushAsync(new CadastroEvolucaoLoteView());
        ...
        private async Task ExecuteIrPaginaExpedicaoCommand() => await _navigationService.PushAsync(new CadastroExpedicaoView());
        ...
        private async Task ExecuteIrPaginaLocalizacaoCommand() => await _navigationService.PushAsync(new LocalizacaoView());
        ...
        private async Task ExecuteIrPaginaOcorrenciaCommand() => await _navigationService.PushAsync(new CadastroOcorrenciaView());
        ...
        private async Task ExecuteIrPaginaMedicaoCommand() => await _navigationService.PushAsync(new CadastroMedicaoView());
