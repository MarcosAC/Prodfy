...
namespace Prodfy.Controls
{
    ...
    {
        public CornerRadiusEffect() : base("TherSistemas.CornerRadiusEffect")
        {
        }
        ...
        public static readonly BindableProperty CornerRadiusProperty = 
            BindableProperty.CreateAttached(
                ...
                0,
                propertyChanged: OnCornerRadiudChanged
           );
        ...
        private static void OnCornerRadiudChanged(BindableObject bindable, object oldValue, object newValue)
        {
